...
# At the end of each adaptive stage, a skip connection is added to the instruction tensor to
# preserve/persist information from the previous stage
# MODIFICATION 1B
    ...
    def forward(self, batch, training=False):
        ...
        for t in range(self.num_iter):
            ...
            for j in range(self.num_ins):
                ...
                # NOTE: Here we are adding a residual connection of sorts to the instructions tensor updates at the end of each iteration stage
                self.instruction.instructions[j] = 0.5 * self.instruction.instructions[
                    j
                ] + 0.5 * q.unsqueeze(1)
